...
public class Personal extends StringRequest{
    ...
    public Personal(int id_cliente,String tipo_doc, int cedula, String genero, String estado, String ciudad_residencia,String dir, String ciudad_nacimiento,int telefono_fijo, Response.Listener<String> listener, Response.ErrorListener error)    {
