...
public class Experiencia extends StringRequest{
    ...
    public Experiencia(int id_cliente,String empresa,String sector,String subsector,String nombre,String logros,int telefono,String ciudad, Response.Listener<String> listener, Response.ErrorListener error)    {
