...
public class Experiencia extends StringRequest{
    ...
    public Experiencia(String empresa,String sector,String subsector,String cargo,String logros,int telefono,String ciudad, Response.Listener<String> listener, Response.ErrorListener error)    {
